...
\begin{solution}
	...
	% \input{Exc1.tikz} TODO: Find the graphics for this or reproduce it (Octave or Matlab, Tikz, ...)
	\begin{figure}[H]
	\center 

	% \subfloat[\label{fig:Exc1_3a_U}]{\input{Exc1_3a_U.tikz}} TODO: Find the graphics for this or reproduce it (Octave or Matlab, ...)

	\hspace{10mm}
	
	%\subfloat[\label{fig:Exc1_3a_C}]{\input{Exc1_3a_C.tikz}} TODO: Find the graphics for this or reproduce it (Octave or Matlab, ...)
...
% 	\subfloat[\label{fig:Exc1_3b_U}]{\input{Exc1_3b_U.tikz}} TODO: Find the graphics for this or reproduce it (Octave or Matlab, ...)
	\hspace{10mm}
% 	\subfloat[\label{fig:Exc1_3b_C}]{\input{Exc1_3b_C.tikz}} TODO: Find the graphics for this or reproduce it (Octave or Matlab, ...)
...
% 	\subfloat[\label{fig:Exc1_4_U}]{\input{Exc1_4_U.tikz}} TODO: Find the graphics for this or reproduce it (Octave or Matlab, ...)
	\hspace{10mm}
% 	\subfloat[\label{fig:Exc1_4_C}]{\input{Exc1_4_C.tikz}} TODO: Find the graphics for this or reproduce it (Octave or Matlab, ...)
...
\begin{solution}
    ...
    % \input{Exc1.tikz} TODO: Find the graphics for this or reproduce it (Octave or Matlab, ...)
    \begin{figure}[H]
    \center 
