...
\begin{solution}
	...
	\input{figures03/Exc1.tikz} 
	\begin{figure}[H]
	\center 

	\subfloat[\label{fig:Exc1_3a_U}]{\input{figures03/Exc1_3a_U.tikz}} 

	\hspace{10mm}
	
	\subfloat[\label{fig:Exc1_3a_C}]{\input{figures03/Exc1_3a_C.tikz}} 
	...
	\subfloat[\label{fig:Exc1_3b_U}]{\input{figures03/Exc1_3b_U.tikz}} 
	\hspace{10mm}
	\subfloat[\label{fig:Exc1_3b_C}]{\input{figures03/Exc1_3b_C.tikz}} 
	...
	\subfloat[\label{fig:Exc1_4_U}]{\input{figures03/Exc1_4_U.tikz}} 
	\hspace{10mm}
	\subfloat[\label{fig:Exc1_4_C}]{\input{figures03/Exc1_4_C.tikz}} 
