...
%     {\includegraphics[width=8cm, height=6cm]{Upwind_Profile}} TODO: Find the graphics for this or reproduce it (Octave or Matlab, ...)
%     {\includegraphics[width=8cm, height=6cm]{Lax-Friedrichs_Profile}} TODO: Find the graphics for this or reproduce it (Octave or Matlab, ...)
%     {\includegraphics[width=8cm, height=6cm]{Lax-Wendroff_Profile}} TODO: Find the graphics for this or reproduce it (Octave or Matlab, ...)
%     {\includegraphics[width=8cm, height=6cm]{Beam-Warming_Profile}} TODO: Find the graphics for this or reproduce it (Octave or Matlab, ...)
    ...
    \begin{figure}[H] 
    \begin{center}
%     {\includegraphics[width=8cm, height=6cm]{Upwind_Accuracy}} TODO: Find the graphics for this or reproduce it (Octave or Matlab, ...)
%     {\includegraphics[width=8cm, height=6cm]{Lax-Friedrichs_Accuracy}} TODO: Find the graphics for this or reproduce it (Octave or Matlab, ...)
%     {\includegraphics[width=8cm, height=6cm]{Lax-Wendroff_Accuracy}} TODO: Find the graphics for this or reproduce it (Octave or Matlab, ...)
%     {\includegraphics[width=8cm, height=6cm]{Beam-Warming_Accuracy}} TODO: Find the graphics for this or reproduce it (Octave or Matlab, ...)
