...
%     \subfigure[]{\includegraphics[width=8cm, height=6cm]{Beam-Warming_Profile}}
    {\includegraphics[width=8cm, height=6cm]{Upwind_Profile}}
    {\includegraphics[width=8cm, height=6cm]{Lax-Friedrichs_Profile}}
    {\includegraphics[width=8cm, height=6cm]{Lax-Wendroff_Profile}}
    {\includegraphics[width=8cm, height=6cm]{Beam-Warming_Profile}}
    ...
    \begin{figure}[H] 
    \begin{center}
    {\includegraphics[width=8cm, height=6cm]{Upwind_Accuracy}}
    {\includegraphics[width=8cm, height=6cm]{Lax-Friedrichs_Accuracy}}
    {\includegraphics[width=8cm, height=6cm]{Lax-Wendroff_Accuracy}}
    {\includegraphics[width=8cm, height=6cm]{Beam-Warming_Accuracy}}
