...
\begin{solution}
    ...
    \begin{figure}[H] 
    \begin{center}
    \subfigure[]{\includegraphics[width=8cm, height=6cm]{figures04/Upwind_Profile}}
    \subfigure[]{\includegraphics[width=8cm, height=6cm]{figures04/Lax-Friedrichs_Profile}}
    \subfigure[]{\includegraphics[width=8cm, height=6cm]{figures04/Lax-Wendroff_Profile}}
    \subfigure[]{\includegraphics[width=8cm, height=6cm]{figures04/Beam-Warming_Profile}}
    {\includegraphics[width=8cm, height=6cm]{figures04/Upwind_Profile}} 
    {\includegraphics[width=8cm, height=6cm]{figures04/Lax-Friedrichs_Profile}} 
    {\includegraphics[width=8cm, height=6cm]{figures04/Lax-Wendroff_Profile}} 
    {\includegraphics[width=8cm, height=6cm]{figures04/Beam-Warming_Profile}} 
    ...
    \begin{figure}[H] 
    \begin{center}
    {\includegraphics[width=8cm, height=6cm]{figures04/Upwind_Accuracy}} 
    {\includegraphics[width=8cm, height=6cm]{figures04/Lax-Friedrichs_Accuracy}} 
    {\includegraphics[width=8cm, height=6cm]{figures04/Lax-Wendroff_Accuracy}} 
    {\includegraphics[width=8cm, height=6cm]{figures04/Beam-Warming_Accuracy}} 
